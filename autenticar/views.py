...
def password_reset_view(request):
	...
	return render(request, 'autenticar/passwordreset.html', formulario)



def login_rede_social_view(request):
	return render(request, 'autenticar/loginredesocial.html')

def login_rede_social_redirecionar_view(request):
	return render(request, 'autenticar/loginredesocialredirecionar.html')
...
def login_google_view(request):
	return render(
		request, 
		'autenticar/logingoogle.html', 
		{"dados":(str(request.META)).replace("', '","'<br>'")}
	)
